      ...
      <div className="max-w-6xl mx-auto">
        <header className="mb-10">
          ...
          <p className="text-gray-600">
            A simple image hosting library using the ServerImages backend
          </p>
        </header>
        ...
        <footer className="mt-16 pt-8 border-t border-gray-200 text-center text-gray-500 text-sm">
          <p>
            ServerImages - A simple image hosting library using the ServerImages
            backend - &copy; Musa/S42 {new Date().getFullYear()}
          </p>
          <p className="hover:underline text-blue-500 cursor-pointer">
            <a
              href="https://github.com/S42yt/ServerImages"
              target="_blank"
